...
```json
{
  ...
  "appSSORedirectURI" : "http://where-for-dinner.<domain name>/login/oauth2/code/sso",
...
┃ ┃ ┃ ┃ ┃ ┃ Debug Wrote values file with json content:   {"devDefaultAccountUsername":"where-for-dinner","artifactVersion":"0.0.1-beta","dbName":"db-where-for-dinner","dbType":"mysql","rabbitMQName":"rmq-where-for-dinner","devDefaultAccountPassword":"letseat","appSSOIssuerURI":"http://authserver.<domainname>","enableSecurity":false,"createRabbitMQCluster":true,"appSSOName":"appsso-where-for-dinner","createResourceClaim":true,"numRabbitMQClusterNodes":1,"enableDefaultDevAccount":true,"artifactId":"where-for-dinner","createDBInstance":true,"serviceNamespace":"service-instances","projectName":"where-for-dinner","workloadNamespace":"workloads","appSSORedirectURI":"http://where-for-dinner.<domain name>/login/oauth2/code/sso"}
┃ ┃ ┃ ┃ ┃ ┗  Info Shelling out to YTT with args: [ytt, -f, /tmp/ytt-input4040768014106090939, --data-values-file, /tmp/accelerator-options11429697390778305620.json, --output-files, /tmp/ytt-output16621238074224410416]
...
┃ ┃ ┃ ┃ ┃ ┃ Debug Wrote values file with json content:   {"devDefaultAccountUsername":"where-for-dinner","artifactVersion":"0.0.1-beta","dbName":"db-where-for-dinner","dbType":"mysql","rabbitMQName":"rmq-where-for-dinner","devDefaultAccountPassword":"letseat","appSSOIssuerURI":"http://authserver.<domainname>","enableSecurity":false,"createRabbitMQCluster":true,"appSSOName":"appsso-where-for-dinner","createResourceClaim":true,"numRabbitMQClusterNodes":1,"enableDefaultDevAccount":true,"artifactId":"where-for-dinner","createDBInstance":true,"serviceNamespace":"service-instances","projectName":"where-for-dinner","workloadNamespace":"workloads","appSSORedirectURI":"http://where-for-dinner.<domain name>/login/oauth2/code/sso"}
┃ ┃ ┃ ┃ ┃ ┗  Info Shelling out to YTT with args: [ytt, -f, /tmp/ytt-input1086100761356278370, --data-values-file, /tmp/accelerator-options10140270714745326919.json, --output-files, /tmp/ytt-output4264535500109896416]
...
┃ ┃ ┃ ┃ ┃ ┃ Debug Wrote values file with json content:   {"devDefaultAccountUsername":"where-for-dinner","artifactVersion":"0.0.1-beta","dbName":"db-where-for-dinner","dbType":"mysql","rabbitMQName":"rmq-where-for-dinner","devDefaultAccountPassword":"letseat","appSSOIssuerURI":"http://authserver.<domainname>","enableSecurity":false,"createRabbitMQCluster":true,"appSSOName":"appsso-where-for-dinner","createResourceClaim":true,"numRabbitMQClusterNodes":1,"enableDefaultDevAccount":true,"artifactId":"where-for-dinner","createDBInstance":true,"serviceNamespace":"service-instances","projectName":"where-for-dinner","workloadNamespace":"workloads","appSSORedirectURI":"http://where-for-dinner.<domain name>/login/oauth2/code/sso"}
┃ ┃ ┃ ┃ ┃ ┗  Info Shelling out to YTT with args: [ytt, -f, /tmp/ytt-input12006644517416521824, --data-values-file, /tmp/accelerator-options12740065271794992244.json, --output-files, /tmp/ytt-output12309159799269903652]
...
┃ ┃ ┃ ┃ ┃ ┃ Debug Wrote values file with json content:   {"devDefaultAccountUsername":"where-for-dinner","artifactVersion":"0.0.1-beta","dbName":"db-where-for-dinner","dbType":"mysql","rabbitMQName":"rmq-where-for-dinner","devDefaultAccountPassword":"letseat","appSSOIssuerURI":"http://authserver.<domainname>","enableSecurity":false,"createRabbitMQCluster":true,"appSSOName":"appsso-where-for-dinner","createResourceClaim":true,"numRabbitMQClusterNodes":1,"enableDefaultDevAccount":true,"artifactId":"where-for-dinner","createDBInstance":true,"serviceNamespace":"service-instances","projectName":"where-for-dinner","workloadNamespace":"workloads","appSSORedirectURI":"http://where-for-dinner.<domain name>/login/oauth2/code/sso"}
┃ ┃ ┃ ┃ ┃ ┗  Info Shelling out to YTT with args: [ytt, -f, /tmp/ytt-input17759740689709631279, --data-values-file, /tmp/accelerator-options16663860428376697024.json, --output-files, /tmp/ytt-output3428367029727307385]
...
┃ ┃ ┃ ┃ ┃ ┃ Debug Wrote values file with json content:   {"devDefaultAccountUsername":"where-for-dinner","artifactVersion":"0.0.1-beta","dbName":"db-where-for-dinner","dbType":"mysql","rabbitMQName":"rmq-where-for-dinner","devDefaultAccountPassword":"letseat","appSSOIssuerURI":"http://authserver.<domainname>","enableSecurity":false,"createRabbitMQCluster":true,"appSSOName":"appsso-where-for-dinner","createResourceClaim":true,"numRabbitMQClusterNodes":1,"enableDefaultDevAccount":true,"artifactId":"where-for-dinner","createDBInstance":true,"serviceNamespace":"service-instances","projectName":"where-for-dinner","workloadNamespace":"workloads","appSSORedirectURI":"http://where-for-dinner.<domain name>/login/oauth2/code/sso"}
┃ ┃ ┃ ┃ ┃ ┗  Info Shelling out to YTT with args: [ytt, -f, /tmp/ytt-input2381640329946580319, --data-values-file, /tmp/accelerator-options14490721187519079208.json, --output-files, /tmp/ytt-output2308571662045217715]
